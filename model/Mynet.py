...
#         self.Attencoder1 = AttConv3d(in_channels, n_filters, kernel_size=3, stride=1, padding=1)
#         self.Attencoder2 = AttConv3d(n_filters, 2 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.Attencoder3 = AttConv3d(2 * n_filters, 4 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.Attencoder4 = AttConv3d(4 * n_filters, 8 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.attention = AxialAttention(dim=36, dim_index=2, heads=4, num_dimensions=3)

#         self.SeUencoder1 = SEConv3d(in_channels, n_filters, kernel_size=3, stride=1, padding=1)
#         self.SeUencoder2 = SEConv3d(n_filters, 2 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.SeUencoder3 = SEConv3d(2 * n_filters, 4 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.SeUencoder4 = SEConv3d(4 * n_filters, 8 * n_filters, kernel_size=3, stride=1, padding=1)

#         self.Up3 = nn.ConvTranspose3d(32 * n_filters, 16 * n_filters, kernel_size=3, stride=2, padding=1,
#                                       output_padding=1)
#         self.decoder3 = BasicConv3d(32 * n_filters, 16 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.Up2 = nn.ConvTranspose3d(16 * n_filters, 8 * n_filters, kernel_size=3, stride=2, padding=1,
#                                       output_padding=1)
#         self.decoder2 = BasicConv3d(16 * n_filters, 8 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.Up1 = nn.ConvTranspose3d(8 * n_filters, 4 * n_filters, kernel_size=3, stride=2, padding=1, output_padding=1)
#         self.decoder1 = BasicConv3d(8 * n_filters, 4 * n_filters, kernel_size=3, stride=1, padding=1)
#         self.conv1x1 = nn.Conv3d(4 * n_filters, out_channels, kernel_size=1, stride=1, padding=0)
